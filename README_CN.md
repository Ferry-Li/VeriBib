...
### Markdown 报告
| 状态 | 引用键 | 原始标题 | 更新后标题 | 原始期刊 | 更新后期刊 | SS 链接 |
|------|--------|---------|------------|----------|------------|---------|
| ✅ 已更新 | li2024size | Size-invariance matters... | Size-invariance Matters... | arXiv preprint | ICML | [链接] |
| ⚠️ 不匹配 | bao2025towards | Towards Size-invariant... | - | IEEE TPAMI | - | - |
